...
const GRID_SIZE = 5;
const IMAGE_SRC = "/assets/level5.jpg";
  ...
  const handleDrop = (index) => {
    ...
    if (isSolved(newPieces)) {
      ...
      setTimeout(() => {
        MySwal.fire({
          title: "Bravo!",
          html: `Completion Time: <strong>${formatTime(timer)}</strong>!<br/>New Gallery: <strong>Level 6</strong><br/><br/>`
