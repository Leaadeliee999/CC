...
const GRID_SIZE = 5;
const IMAGE_SRC = "/assets/level3.jpg";
...
function Gameplay3() {
  ...
  const handleDrop = (index) => {
    ...
    if (isSolved(newPieces)) {
      ...
      saveScoreToFirebase(timer); // Simpan skor ke Firebase
      setTimeout(() => {
        MySwal.fire({
          title: "Bravo!",
          html: `Completion Time: <strong>${formatTime(timer)}</strong>!<br/>New Gallery: <strong>Level 4</strong><br/><br/>`
