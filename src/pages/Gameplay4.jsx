...
const GRID_SIZE = 5;
const IMAGE_SRC = "/assets/level4.jpg";
...
function Gameplay4() {
  ...
  const handleDrop = (index) => {
    ...
    if (isSolved(newPieces)) {
      ...
      saveScoreToFirebase(timer); // simpan skor
      setTimeout(() => {
        MySwal.fire({
          title: "Bravo!",
          html: `Completion Time: <strong>${formatTime(timer)}</strong>!<br/>New Gallery: <strong>Level 5</strong><br/><br/>`
